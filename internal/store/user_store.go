...
var AnonymousUser = &User{} // EVERYONE WHOS NOY LOGGED IN
...
func (s *PostgresUserStore) GetUserToken(scope, plainTestPassword string) (*User, error) {
	tokenHash := sha256.Sum256([]byte(plainTestPassword))
